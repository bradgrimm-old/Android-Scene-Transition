 ...
 * For example, here is a minimal resource file that declares a {@link android.transition.ChangeBounds} transition:</p>
 *
...
public abstract class Transition implements Cloneable {
     ...
     * @attr ref R.styleable#Transition_duration
     */
     ...
     * @return This transition object.
     * @attr ref R.styleable#Transition_startDelay
     */
     ...
     * @return This transition object.
     * @attr ref R.styleable#Transition_interpolator
     */
    ...
    /**
     * Returns the set of property names used stored in the {@link android.transition.TransitionValues}
     ...
     * {@link android.transition.TransitionValues}. The default implementation returns <code>null</code>.
     */
     ...
     *
     * @see #captureEndValues(android.transition.TransitionValues)
     * @see #createAnimator(android.view.ViewGroup, android.transition.TransitionValues, android.transition.TransitionValues)
     */
     ...
     * the transitionValues structure when this method is called.
     *
     * @see #captureStartValues(android.transition.TransitionValues)
     * @see #createAnimator(android.view.ViewGroup, android.transition.TransitionValues, android.transition.TransitionValues)
     */
    ...
    public static interface TransitionListener {
         ...
         * events. That is, {@link #onTransitionEnd(com.hirevue.manager.tmp.transition.Transition)} is always called,
         ...
         * Note that cancel may be called by a parent {@link android.transition.TransitionSet} on
         ...
         * Note that createAnimator() may be called by a parent {@link android.transition.TransitionSet} on
         * a child transition which has not yet started. This allows the child
         * transition to restore state on target objects which was set at
         * {@link #createAnimator(android.view.ViewGroup, android.transition.TransitionValues, android.transition.TransitionValues)
         * createAnimator()} time.
         ...
         * Note that resume() may be called by a parent {@link android.transition.TransitionSet} on
         * a child transition which has not yet started. This allows the child
         * transition to restore state which may have changed in an earlier call
         * to {@link #onTransitionPause(com.hirevue.manager.tmp.transition.Transition)}.
         *
