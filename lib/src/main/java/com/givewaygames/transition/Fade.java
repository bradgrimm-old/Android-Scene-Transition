 ...
 * {@link android.transition.Scene#getSceneForLayout(android.view.ViewGroup, int, android.content.Context)
...
public class Fade extends Visibility {
    ...
    public Animator onAppear(ViewGroup sceneRoot,
        ...
        //final Transitionable transitionable = (Transitionable) endValues.view;
        if (DBG) {
//            View startView = (startValues != null) ? startValues.view : null;
//            Log.d(LOG_TAG, "Fade.onAppear: startView, startVis, endView, endVis = " +
//                    startView + ", " + startVisibility + ", " + transitionable + ", " + endVisibility);
        }
        //transitionable.setTransitionAlpha(0);
        TransitionListener transitionListener = new TransitionListenerAdapter() {
            ...
            public void onTransitionCancel(Transition transition) {
                //transitionable.setTransitionAlpha(1);
                mCanceled = true;
            }
            ...
            public void onTransitionPause(Transition transition) {
                //mPausedAlpha = transitionable.getTransitionAlpha();
                //transitionable.setTransitionAlpha(1);
            }

            @Override
            public void onTransitionResume(Transition transition) {
                //transitionable.setTransitionAlpha(mPausedAlpha);
            }
        };
    ...
    public Animator onDisappear(ViewGroup sceneRoot,
        ...
        if (overlayView != null) {
            ...
            //final Transitionable finalTransitionable = (Transitionable) view;
            ...
            final AnimatorListenerAdapter endListener = new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    //finalTransitionable.setTransitionAlpha(startAlpha);
        ...
        if (viewToKeep != null) {
            ...
            final AnimatorListenerAdapter endListener = new AnimatorListenerAdapter() {
                ...
                public void onAnimationPause(Animator animation) {
                    ...
                    mPausedAlpha = finalTransitionable.getTransitionAlpha();
                    finalTransitionable.setTransitionAlpha(startAlpha);
                }
                ...
                public void onAnimationResume(Animator animation) {
                    ...
                    finalTransitionable.setTransitionAlpha(mPausedAlpha);
                }
