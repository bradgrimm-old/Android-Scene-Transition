...
public final class Scene {
     ...
     * created by the caching factory method {@link com.hirevue.manager.tmp.transition.Scene#getCurrentScene(android.view.View)}.</p>
     *
     * @param sceneRoot The root of the hierarchy in which scene changes
     * and transitions will take place.
    ...
    /**
     * Gets the current {@link com.hirevue.manager.tmp.transition.Scene} set on the given view. A scene is set on a view
     ...
     * @see com.hirevue.manager.tmp.transition.Scene#Scene(android.view.ViewGroup, int, android.content.Context)
     * @see com.hirevue.manager.tmp.transition.Scene#Scene(android.view.ViewGroup, android.view.ViewGroup)
     */
