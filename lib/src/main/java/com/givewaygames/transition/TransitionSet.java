 ...
 * others play {@link #ORDERING_SEQUENTIAL}. For example, {@link android.transition.AutoTransition}
 * uses a TransitionSet to sequentially play a Fade(Fade.OUT), followed by
 * a {@link android.transition.ChangeBounds}, followed by a Fade(Fade.OUT) transition.
 *
