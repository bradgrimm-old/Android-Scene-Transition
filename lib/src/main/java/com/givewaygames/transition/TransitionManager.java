 ...
 * {@link Scene#getSceneForLayout(android.view.ViewGroup, int, android.content.Context)}. For the
...
public class TransitionManager {
     ...
     * Equivalent to calling {@link #beginDelayedTransition(android.view.ViewGroup, Transition)}
